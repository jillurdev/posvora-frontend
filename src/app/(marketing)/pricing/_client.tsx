						...
						{plans.map((plan, idx) => {
							...
							return (
								<Reveal key={plan.id} delayMs={idx * 60}>
									...
									>
										{highlighted && (
											<span className="mb-3 inline-flex w-fit items-center rounded-sm bg-[var(--mk-gold)] px-2 py-0.5 font-[var(--font-mk-mono)] text-[10px] font-semibold uppercase tracking-wide text-[var(--mk-ink)]">
												Most popular
											</span>
										)}
										...
										<Link
											...
											className={`mt-8 inline-flex h-10 w-full items-center justify-center rounded-md text-sm font-medium transition-colors ${
												highlighted
													? "bg-[var(--mk-gold)] text-[var(--mk-ink)] hover:bg-[var(--mk-gold-soft)]"
											...
											className={`rounded-sm px-2 py-0.5 font-[var(--font-mk-mono)] text-[10px] font-medium uppercase tracking-wide ${
												r.status === "Live now"
													...
													: r.status === "In progress"
														? "bg-[var(--mk-gold-soft)] text-[var(--mk-ink)]"
